...
<p align="center">
	<strong><em> To view a list of all bot commands, enter the <code>"documentation"</code> command in the chat of any server where there is a bot (do not forget to specify the prefix before the command name), the bot will send you a list of all available commands to the bos. The name of the file where the <code>"documentation"</code>command is stored: <a href="">system_bot.py</a> </strong></em>
</p>
